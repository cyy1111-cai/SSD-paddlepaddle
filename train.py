...
# 查看当前挂载的数据集目录
get_ipython().system('cd /home/aistudio/data/data4379 && unzip -qo pascalvoc.zip')#进存放pascalvoc.zip的路径解压
...
get_ipython().system('cp data/data5389/mobilenet_v1_imagenet.zip pretrained-model/')
get_ipython().system('cd pretrained-model && unzip -qo mobilenet_v1_imagenet.zip')
get_ipython().system('cd pretrained-model && mv mobilenet_v1_imagenet/* . && rm -r mobilenet_v1_imagenet && rm mobilenet_v1_imagenet.zip')
